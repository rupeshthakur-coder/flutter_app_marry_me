...
class CustomAppBarForDashboard extends StatelessWidget implements PreferredSizeWidget {
  final bool scrolledUnderElevation;
  final String pageName;

  const CustomAppBarForDashboard({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        // Background image
        Image.asset(
          'assets/dashboard/dashboard_appbar.png',
          fit: BoxFit.cover,
        ),
        Padding(
